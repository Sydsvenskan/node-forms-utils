...
/** @typedef {{ [formPartKey: string]: Form|Promise<Form> }} FormParts */
/** @typedef {{ [formPartKey: string]: FormBound }} FormPartsBound */
 ...
 * @param {Object<string, any> | import('http').IncomingMessage} body
 * @returns {Promise<{ success?: boolean, error?: boolean, empty?: boolean, forms: FormPartsBound }>}
 */
